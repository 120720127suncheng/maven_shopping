...
public class VisitorResume implements Serializable {
	...
	private String visitorJobObjective;//游客的意向职位
	private String visitorResumeName;//简历名称
	private String visitorSpeciality;//专业
	private String visitorEducationBackground;//教育背景
	private String vistorEducationDescription;//教育经历
	private Integer visitorWorkingYears;//工作年限
	private String visitorWorkingDescription;//工作经历
	private Integer visitorExpectedSalary;//期望薪资
	private String visitorResumeAttachment;//简历附件
